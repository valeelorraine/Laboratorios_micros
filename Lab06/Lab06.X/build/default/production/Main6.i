...
ISR:
    BTFSC INTCON, 2 ; Revisar ((INTCON) and 07Fh), 2 interrupción de overflow TMR0
    CALL ACC_DISP
    BTFSS ((PIR1) and 07Fh), 0 ; Revisar bandera del overflow
    CALL Inc1 ; Incrementar la variable
    BTFSC ((PIR1) and 07Fh), 1 ; Revisar bandera del TMR2
...
Interrupciones:
    banksel INTCON
    BCF INTCON, 2 ; Encender ((INTCON) and 07Fh), 2 interrupción de overflow TMR2
    BSF INTCON, 5 ; Encender TOIE interrupción de TMR0
    BSF INTCON, 6 ; Encender ((INTCON) and 07Fh), 6
    BSF INTCON, 7 ; Encender ((INTCON) and 07Fh), 7 interrupción de global
    ...
    banksel TMR0
    BCF ((PIR1) and 07Fh), 0 ; Limpiar bandera del timer 1
    BCF ((PIR1) and 07Fh), 1 ; Limpiar bandera del timer 2
